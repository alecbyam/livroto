  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "À propos — Livroto" },
      {
        ...
        content:
          "La marketplace locale de Bunia : commerçants vérifiés, livreurs du quartier, paiement cash.",
      },
    ...
    <SiteLayout>
      ...
      <section className="container mx-auto max-w-4xl px-4 py-12 md:py-20">
        ...
        <div className="mt-16 rounded-3xl border border-border bg-card p-8 md:p-10">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <MapPin className="h-4 w-4" /> Bunia, Ituri — RDC
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Heart className="h-4 w-4 text-primary" /> Fait avec amour ici, chez nous
            </span>
          </div>
        </div>
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <Link
            to="/contact"
            className="inline-flex h-11 items-center rounded-full border border-border bg-card px-6 text-sm font-medium hover:border-primary/50"
          >
            Nous contacter
          </Link>
        </div>
